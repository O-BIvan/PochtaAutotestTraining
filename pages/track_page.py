...
class TrackPage(BasePage):
    def should_be_wrong_track_id_message(self):
        assert self.is_element_present(*TrackPageLocators.WRONG_TRACK_ID_MESSAGE), "Wrong track id message not present"
    ...
    def search_wrong_track_id(self):
        ...
        error_message.send_keys(TrackIds.TRACK_ID_WRONG)